			...
			<div class="card-header border-0">
              ...
              <form role="form" action="proses_nilai.php" method="POST" class="mb-5">
                <div class="card-body text-dark">
				    ...
				    <input type="number"  onkeypress="return angka(event)"  name="nim" class="form-control" id="nim" placeholder="Enter NISN">
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="fakultas" name="fakultas" placeholder="Prodi">
				  </div>
